...
from guided_dc.policy.common.modules import (
    Conv1dBlock,
    Downsample1d,
    SinusoidalPosEmb,
    Upsample1d,
...
class VisionUnet1D(nn.Module):
    def __init__(
        ...
        cond_block_dim = dsed + self.obs_encoder.feat_dim
        use_large_encoder_in_block = (
            self.obs_encoder.cond_mlp_dims is None and not smaller_encoder
        )
    ...
    def forward(
        ...
        **kwargs,
        ...
        cond_encoded = self.obs_encoder(img=cond["rgb"], obs=cond["state"])
